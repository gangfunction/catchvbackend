...
public class QFaceData extends EntityPathBase<FaceData> {
    ...
    private static final long serialVersionUID = -582582832L;
    ...
    public QFaceData(Class<? extends FaceData> type, PathMetadata metadata, PathInits inits) {
        ...
        this.imageRequest = inits.isInitialized("imageRequest") ? new com.catchvbackend.domain.QImageRequest(forProperty("imageRequest"), inits.get("imageRequest")) : null;
        this.imageResult = inits.isInitialized("imageResult") ? new com.catchvbackend.domain.QImageResult(forProperty("imageResult"), inits.get("imageResult")) : null;
    }
